...
(function() {
  ...
  define(['aloha', 'jquery', 'css!../../../oer/overlay/css/popover.css'], function(Aloha, jQuery) {
    var Bootstrap_Popover__position, Bootstrap_Popover_hide, Bootstrap_Popover_show, Helper, Popover, bindHelper, findMarkup, monkeyPatch, popover_template, selectionChangeHandler, _ref;
    ...
    if (((_ref = $.fn.tooltip.defaults) != null ? _ref.container : void 0) || !$.fn.tooltip.defaults) {
      monkeyPatch();
    }
    Popover = {
      MILLISECS: 2000,
        ...
        $el.on('show-popover.bubble', this.selector, function(evt, hint) {
          ...
          if (!$node.data('aloha-bubble-visible')) {
            ...
            if (_this.markerclass) {
              if ((_ref1 = $node.data('popover')) != null) {
                if ((_ref2 = _ref1.$tip) != null) {
                  _ref2.addClass(_this.markerclass);
                }
              }
            }
